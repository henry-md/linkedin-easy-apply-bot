...
REQUIREMENT FOR THE ABOVE^ (element 6): Enter a whole number between 0 and 99
...
REQUIREMENT FOR THE ABOVE^ (element 9): Enter a whole number between 0 and 99
...
REQUIREMENT FOR THE ABOVE^ (element 12): Enter a whole number between 0 and 99
...
REQUIREMENT FOR THE ABOVE^ (element 16): Please make a selection
...
REQUIREMENT FOR THE ABOVE^ (element 19): Please enter a valid answer
